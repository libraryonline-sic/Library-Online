  ...
  return (
    <body>
      <div className="form">
        <center>
          <div>
            <p className="judul">Daftarkan akunmu di Petal!</p>
          </div>
          <div>
            <p className="subjudul">Silahkan daftar Untuk Melanjutkan</p>
          </div>
          <div className="kontenerinput">
            ...
            <div className="passwordconf">
              <input type="text" placeholder="Konfirmasi Password Anda" />
            </div>
